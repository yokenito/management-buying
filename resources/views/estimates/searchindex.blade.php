                ...
                <div class="my-2 d-flex">
                    ...
                    <div class="ps-3">
                        ...
                        <select name="status" class="form-control mt-2">
                            ...
                            <option value="2" <?php if($request->status==2){echo "selected";} ?>>受注</option>
                            <option value="3" <?php if($request->status==3){echo "selected";} ?>>期限切れ</option>
                        </select>
                    </div>
                </div>
