...
@section('content')
    <main>
        <h2 class="section-ttl">新規見積書の作成</h2>
        @if ($errors->any())
            <div>
                <ul>
        ...
        <form action="{{route('estimates.store')}}" method="post" class="w-75">
            @csrf
            <div>
            ...
            <div class="mt-4">
                ...
                <div class="d-flex">
                    ...
                    <input type="hidden" name="client_id" class="form-control w-50" id="set-client-id" value="{{old('client_name')}}" readonly>
            ...
            <div class="mt-4">
                ...
                <input type="text" name="delivery_line" class="form-control" id="estimate-" value="{{old('delivery_line')}}">
            </div>
            <div class="mt-4">
                <label for="date_line" class="form-label">有効期限<span class="form-note">必須</span></label>
                <input type="text" name="date_line" class="form-control" value="{{old('date_line')}}">
            </div>
            <div class="mt-4">
            ...
            <div class="mt-4">
                ...
                <textarea name="estimate_requirement" class="form-control">{{old('estimate_requirement')}}</textarea>
            </div>
            <div class="mt-4">
